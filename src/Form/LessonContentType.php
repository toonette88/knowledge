...
/**
 * Form type for creating and editing LessonContent entities.
 */
class LessonContentType extends AbstractType
{
    ...
    public function buildForm(FormBuilderInterface $builder, array $options): void
    {
        $builder
            ->add('content', TextareaType::class, [
                'label' => 'Contenu de la partie', // Field label
                'attr' => ['class' => 'form-control'] // Adds Bootstrap styling
            ]);
    }
    ...
    public function configureOptions(OptionsResolver $resolver): void
    {
        $resolver->setDefaults([
            'data_class' => LessonContent::class, // Binds this form to the LessonContent entity
        ]);
    }
}
